...
Ext.define('Apptest.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Apptest.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Apptest.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
