...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelHelp("ireTQrhJBXipxWWVfKz6ECRAOJZG5yhs3kbT7gsZzGM8EypZkT");
        useraccesslevel.setLevelDescription("MYoaZMvHDRqFRs40YEvi3Z0Nm2DIUK67saWD2dVNKdzHRQxJE1");
        useraccesslevel.setLevelName("WHDSy41GOAyn3Jfg4zMhZggqzF1TGCaMjDahOa6W9LKtxGUxgC");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("MpFkiejz5SoQR3V1rlUsRfyR87umbuvRhUlHfmLxlEu8oU8rSw");
        ...
        useraccessdomain.setDomainDescription("JRgbvRwHIFNaeTzRIy4jCJ6D2ghIQdfOEZu4jK37O0CO7jTxfG");
        useraccessdomain.setDomainName("qURPmBt3q5yHaXsNHqozCORWUIGoWCnBJaUhVKVDlvLeTIe8yv");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("3xCs2NLc96vcnjFh3LBLxwBD036G6gUeeD1CY7VI8WA1ss2G5g");
        useraccessdomain.setDomainIcon("AAqMpOGsD4O0lDq7LxNI3ZHezzNtsWtHSidcqNtfAm1Z3q0oZR");
        ...
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459240902314l));
        user.setAllowMultipleLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setPasswordAlgo("rK07SaIb0yl03XV1ph0nH9NIiLWlwNpxGk4dEO2wXBP6isnhR3");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459240902459l));
        user.setChangePasswordNextLogin(1);
        user.setIsLocked(1);
        user.setSessionTimeout(3358);
        user.setIsDeleted(1);
        user.setUserAccessCode(22309);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("qTZdU08yQQJ6nPHQII3OvvdFa9fuWqonFWJGryQK5HBKU7Gmwk");
        question.setQuestionDetails("KXqyeYIu9X");
        question.setQuestion("F7p6ZrS20sOp50J4u7AHnKBunvixRFWRF8IeXwp1IhRyH6Jkji");
        ...
        passrecovery.setAnswer("7mGOUaNlvTO7xvAYJ4GhcY99wyUDHLpkN5N7vwQsejnOLHY3Vr");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("xJ7iQFNXtfTUhlfz1b9v3RqOBVRP3Woh");
        userdata.setOneTimePassword("a0x4Z4LG8AuOJ72Xu4Sf6Bz0og2cZKH5");
        userdata.setUser(user);
        userdata.setLast5Passwords("TibuDIIfvuDDqA9dHku0nFw7tWPq0IPwxRHa4sZ79eymiDMy4x");
        userdata.setOneTimePasswordExpiry(1);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459240903340l));
        userdata.setPassword("QWYGxL3Nn9MdWAet7cgKrVdNQ0XE3X6V1EBZ2F9cbEHKjawEo1");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 66024));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "P829Uj1pWmdxYm1uCZ9LWCFTdjkjYvU21EZ4qFxbdc9gbXe8VQupLzYG8hYnWYz8k"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6180));
